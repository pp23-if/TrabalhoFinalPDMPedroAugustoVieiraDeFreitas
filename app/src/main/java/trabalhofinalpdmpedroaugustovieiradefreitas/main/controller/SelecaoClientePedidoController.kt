...
class SelecaoClientePedidoController : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_selecao_clientes_cadastro_pedido)
        ...
        lifecycleScope.launch {
            ...
            if (listaDeClientes.isNotEmpty()) {
                val adaptador = ClienteAdapter(this@SelecaoClientePedidoController, listaDeClientes)
                ...
                listViewClientesRecuperados.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
                    ...
                    val intent = Intent(this@SelecaoClientePedidoController, SelecaoPedidoEItemController::class.java)
    ...
    fun inicializaComponentesInterfaceGrafica() {
        listViewClientesRecuperados = findViewById(R.id.listViewSelecaoClientesCadastroPedido)
        botaoDeVoltar = findViewById(R.id.botaoVoltarSelecaoClientesCadastroPedido)
    }
}
