...
class SelecaoVisualizacaoClientesController : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_selecao_visualizacao_cliente_pedido)
        ...
        lifecycleScope.launch {
            ...
            if (listaDeClientes.isNotEmpty()) {
                val adaptador = ClienteAdapter(this@SelecaoVisualizacaoClientesController, listaDeClientes)
                ...
                listViewClientesRecuperados.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
                    ...
                    val intent = Intent(this@SelecaoVisualizacaoClientesController, SelecaoVisualizacaoPedidoClienteSelecionadoController::class.java)
    ...
    fun inicializaComponentesInterfaceGrafica() {
        ...
        botaoDeVoltar = findViewById(R.id.botaoVoltarVisualizacaoSelecaoPedidoCliente)
    }
}
