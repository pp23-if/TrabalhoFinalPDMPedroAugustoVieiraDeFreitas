...
class SelecaoPedidoAlteracaoController : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_selecao_pedido_alteracao)
        ...
        lifecycleScope.launch {
            ...
            if (listaDePedidos.isNotEmpty()) {
                val adaptador = PedidoAdapter(this@SelecaoPedidoAlteracaoController, listaDePedidos)
                ...
                listViewPedidosRecuperados.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
                    ...
                    val intent = Intent(this@SelecaoPedidoAlteracaoController, SelecaoItemPedidoAlteracaoController::class.java)
    ...
    fun inicializaComponentesInterfaceGrafica() {
        listViewPedidosRecuperados = findViewById(R.id.listViewSelecaoPedidoAlteracao)
        botaoDeVoltar = findViewById(R.id.botaoVoltarSelecaoPedidoAlteracao)
    }
}
