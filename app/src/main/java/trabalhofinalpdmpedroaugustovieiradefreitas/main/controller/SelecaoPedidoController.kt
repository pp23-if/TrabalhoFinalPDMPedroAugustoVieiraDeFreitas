...
class SelecaoPedidoController : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_selecao_pedidos_cadastro_item_pedido)
        ...
        lifecycleScope.launch {
            ...
            if (listaDePedidos.isNotEmpty()) {
                val adaptador = PedidoAdapter(this@SelecaoPedidoController, listaDePedidos)
                ...
                listViewPedidosRecuperados.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
                    ...
                    val intent = Intent(this@SelecaoPedidoController, SelecaoItemPedidoController::class.java)
    ...
    fun inicializaComponentesInterfaceGrafica() {
        listViewPedidosRecuperados = findViewById(R.id.listViewSelecaoPedidoCadastroItemPedido)
