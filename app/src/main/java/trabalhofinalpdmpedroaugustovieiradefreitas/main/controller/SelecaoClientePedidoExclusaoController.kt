...
class SelecaoClientePedidoExclusaoController : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_selecao_cliente_exclusoes_pedido_item)
        ...
        lifecycleScope.launch {
            ...
            if (listaDeClientes.isNotEmpty()) {
                val adaptador = ClienteAdapter(this@SelecaoClientePedidoExclusaoController, listaDeClientes)
                ...
                listViewClientesRecuperados.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
                    ...
                    val intent = Intent(this@SelecaoClientePedidoExclusaoController, SelecaoPedidoItemExclusaoController::class.java)
    ...
    fun inicializaComponentesInterfaceGrafica() {
        listViewClientesRecuperados = findViewById(R.id.listViewSelecaoClienteExclusoes)
        botaoDeVoltar = findViewById(R.id.botaoVoltarVisualizacaoSelecaoClienteExclusoes)
    }
}
