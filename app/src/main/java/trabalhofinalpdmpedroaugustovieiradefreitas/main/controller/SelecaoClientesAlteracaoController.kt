...
class SelecaoClientesAlteracaoController : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_selecao_clientes)
        ...
        lifecycleScope.launch {
            ...
            if (listaDeClientes.isNotEmpty()) {
                adaptador = ClienteAdapter(this@SelecaoClientesAlteracaoController, listaDeClientes)
                ...
                listViewClientesRecuperados.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
                    ...
                    val intent = Intent(this@SelecaoClientesAlteracaoController, AtualizacaoClienteController::class.java)
    ...
    fun inicializaComponentesInterfaceGrafica() {
        listViewClientesRecuperados = findViewById(R.id.listViewSelecaoClientesCadastrados)
        botaoDeVoltar = findViewById(R.id.botaoVoltarSelecaoClientes)
    }
}
