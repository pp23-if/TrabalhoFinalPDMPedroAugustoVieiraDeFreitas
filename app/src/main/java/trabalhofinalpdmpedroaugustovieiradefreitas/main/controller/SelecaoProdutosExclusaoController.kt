...
class SelecaoProdutosExclusaoController : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_selecao_exclusao_produto)
        ...
        lifecycleScope.launch {
            ...
            if (listaDeProdutos.isNotEmpty()) {
                adaptador = ProdutoAdapter(this@SelecaoProdutosExclusaoController, listaDeProdutos)
                ...
                listViewProdutosRecuperados.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
                    ...
                    val intent = Intent(this@SelecaoProdutosExclusaoController, ExclusaoProdutoController::class.java)
    ...
    fun inicializaComponentesInterfaceGrafica() {
        listViewProdutosRecuperados = findViewById(R.id.listViewSelecaoProdutosParaExcluir)
        botaoDeVoltar = findViewById(R.id.botaoVoltarSelecaoProdutosExclusao)
    }
}
